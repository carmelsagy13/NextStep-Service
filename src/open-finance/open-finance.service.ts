...
export class OpenFinanceService {
  ...
  private async callLlmForProfile(
    ...
    const systemPrompt = [
      ...
      // PARKED — broader savings definition (securities + self-reported
      // off-platform holdings). Re-enable by swapping for the line above.
      ...
      // PARKED — overdraft feature (see FinancialFeatures.overdraft*).
  ...
  private async callLlmForStateAndReconciliation(
    ...
    const systemPrompt = [
      ...
      // PARKED — broader savings definition (securities + self-reported holdings).
